  ...
  return (
    <section className="relative py-32 px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-5xl font-bold text-center mb-4 bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="group relative bg-linear-to-b from-slate-900/80 to-slate-950/80 backdrop-blur-sm border border-blue-500/20 rounded-xl p-8 hover:border-blue-400/50 transition-all hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] hover:-translate-y-2"
              style={{ animation: `fadeInUp 0.8s ease-out ${idx * 0.1}s both` }}
            >
              <div className="absolute inset-0 bg-linear-to-b from-blue-500/5 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity" />
